...
const ShowCat = () => {
    const webURL = 'https://api.thecatapi.com/v1/images/search?limit=12&has_breeds=1&api_key=live_6qrwtqwMuahNsFhzTDTk4z9eb5HRwyRdw5fxBpsnyr9EOcGcZfgRjJ4th0stJWOC';
    ...
    const handleAdopt = (cat) => {
      ...
      if (!storedIsLoggedIn) {
        navigate('/signup', { state: { pet: cat, type: 'cat' } }); // Redirect to the SignUp page if not logged in
      } else {
